...
public class TestData {
        ...
        static PersonFullDetails person1 = new PersonFullDetails("Eric", "Cadigan", "951 LoneTree Rd", "Culver",
                        "97451", "841-874-7458", null, null, 76, null, null, null);
        static PersonFullDetails person2 = new PersonFullDetails("Zach", "Zemicks", "892 Downing Ct", "Culver", "97451",
                        "841-874-7512", null, null, 4, null, null, null);
        static PersonFullDetails person3 = new PersonFullDetails("Warren", "Zemicks", "892 Downing Ct", "Culver",
                        "97451", "841-874-7512", null, null, 36, null, null, null);
        static PersonFullDetails person4 = new PersonFullDetails("Sophia", "Zemicks", "892 Downing Ct", "Culver",
                        "97451", "841-874-7878", null, null, 33, null, null, null);
        static PersonFullDetails person5 = new PersonFullDetails("Jonanathan", "Marrack", "29 15th St", "Culver",
                        "97451", "841-874-6513", null, null, 32, null, null, null);
        public static List<PersonFullDetails> coveredByFirestation_2 = List.of(person5, person4, person3, person2,
                        person1);
        ...
        static PersonFullDetails personFire_1 = new PersonFullDetails(null, "Cooper", null, null, null, "841-874-6874",
                        null, null, 27, new String[] { "hydrapermazol:300mg", "dodoxadin:30mg" },
                        new String[] { "shellfish" }, null);
        ...
        // Flood Test Data
        static PersonFullDetails personFlood_1 = new PersonFullDetails("Lily", "Cooper", null, null, null,
                        "841-874-9845", null, null, 27, new String[] {}, new String[] {}, null);

        static PersonFullDetails personFlood_2 = new PersonFullDetails("Tony", "Cooper", null, null, null,
                        "841-874-6874", null, null, 27, new String[] { "hydrapermazol:300mg", "dodoxadin:30mg" },
                        new String[] { "shellfish" }, null);

        static PersonFullDetails personFlood_3 = new PersonFullDetails("Ron", "Peters", null, null, null,
                        "841-874-8888", null, null, 56, new String[] {}, new String[] {}, null);

        static PersonFullDetails personFlood_4 = new PersonFullDetails("Allison", "Boyd", null, null, null,
                        "841-874-9888", null, null, 56, new String[] { "aznol:200mg" }, new String[] { "nillacilan" },
                        null);

        static FloodDTO floodDTO_1 = new FloodDTO("489 Manchester St", List.of(personFlood_1));
        static FloodDTO floodDTO_2 = new FloodDTO("112 Steppes Pl",
                        List.of(personFlood_2, personFlood_3, personFlood_4));
        public static List<FloodDTO> floodDTOs = List.of(floodDTO_1, floodDTO_2);

        // getAllByFirstNameAndLastName Test Data
        public static PersonFullDetails Tony_Cooper = new PersonFullDetails("Tony", "Cooper", "112 Steppes Pl", "Culver", "97451", 
                        null, "tcoop@ymail.com", null, 27, new String[] { "hydrapermazol:300mg", "dodoxadin:30mg" }, new String[] { "shellfish" }, null);

        public static PersonFullDetails Lily_Cooper = new PersonFullDetails("Lily", "Cooper", "489 Manchester St", "Culver", "97451", 
